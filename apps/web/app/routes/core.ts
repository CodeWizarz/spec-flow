...
export const coreRoutes: RouteConfigEntry[] = [
  ...
  layout("./(all)/accounts/forgot-password/layout.tsx", [
    route(
      ...
      "./(all)/accounts/forgot-password/page.tsx",
    ),
  ]),
  layout("./(all)/accounts/reset-password/layout.tsx", [
    route(
      "accounts/reset-password",
      "./(all)/accounts/reset-password/page.tsx",
    ),
  ]),
  ...
  // Onboarding
  layout("./(all)/onboarding/layout.tsx", [
    route("onboarding", "./(all)/onboarding/page.tsx"),
  ]),

  // Invitations
  layout("./(all)/invitations/layout.tsx", [
  ...
  layout("./(all)/layout.tsx", [
    ...
    layout("./(all)/[workspaceSlug]/layout.tsx", [
      ...
      layout("./(all)/[workspaceSlug]/(projects)/layout.tsx", [
        ...
        // SpecFlow (Signals, Insights, Specs, Memory, Health)
        route(":workspaceSlug/signals", "./routes/signals-page.tsx"),
        route(":workspaceSlug/insights", "./routes/insights-page.tsx"),
        route(":workspaceSlug/specs", "./routes/specs-page.tsx"),
        route(":workspaceSlug/memory", "./routes/memory-page.tsx"),
        route(":workspaceSlug/health", "./routes/health-page.tsx"),
        ...
        // Analytics
        layout(
          "./(all)/[workspaceSlug]/(projects)/analytics/[tabId]/layout.tsx",
          [
            route(
        ...
        // Browse
        layout(
          "./(all)/[workspaceSlug]/(projects)/browse/[workItem]/layout.tsx",
          [
            route(
        ...
        layout("./(all)/[workspaceSlug]/(projects)/drafts/layout.tsx", [
          route(
            ...
            "./(all)/[workspaceSlug]/(projects)/drafts/page.tsx",
          ),
        ]),
        ...
        // Profile
        layout(
          "./(all)/[workspaceSlug]/(projects)/profile/[userId]/layout.tsx",
          [
            route(
        ...
        layout("./(all)/[workspaceSlug]/(projects)/stickies/layout.tsx", [
          route(
            ...
            "./(all)/[workspaceSlug]/(projects)/stickies/page.tsx",
          ),
        ]),

        // Workspace Views
        layout(
          "./(all)/[workspaceSlug]/(projects)/workspace-views/layout.tsx",
          [
            route(
        ...
        // Archived Projects
        layout(
          "./(all)/[workspaceSlug]/(projects)/projects/(detail)/archives/layout.tsx",
          [
            route(
        ...
        // Project List
        layout(
          "./(all)/[workspaceSlug]/(projects)/projects/(list)/layout.tsx",
          [
            route(
        ...
        // Project Detail
        layout(
          "./(all)/[workspaceSlug]/(projects)/projects/(detail)/[projectId]/layout.tsx",
          [
            // Project Issues List
            layout(
      ...
      layout("./(all)/[workspaceSlug]/(settings)/layout.tsx", [
        ...
        layout(
          "./(all)/[workspaceSlug]/(settings)/settings/projects/layout.tsx",
          [
            ...
            layout(
              "./(all)/[workspaceSlug]/(settings)/settings/projects/[projectId]/layout.tsx",
              [
                // Project Settings
                route(
    ...
    layout("./(all)/settings/profile/layout.tsx", [
      route(
        ...
        "./(all)/settings/profile/[profileTabId]/page.tsx",
      ),
    ]),
  ]),
  ...
  route(
    ...
    "routes/redirects/core/api-tokens.tsx",
  ),
  ...
  route(
    ...
    "routes/redirects/core/inbox.tsx",
  ),
